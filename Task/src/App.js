...
const App = () => {
  ...
  const handleScroll = () => {
    ...
    if (scrollPosition > 1000) { // replace 1000 with your desired scroll position
  ...
  return (
    <> 
      ...
      <div>
      {showNotification && (
        <button onClick={handleWhatsAppClick} className="contact-message-box btn-wb ">	<i class="fab fa-whatsapp wb"></i></button>
      )}
      <Router>
        <Navbar />
        <Switch>
