        ...
        <div className="container">
          <div>
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="card">
                  <div className="card-text">
                    ...
                    since 2018. I greatly appreciate their thorough
                    understanding of our business needs which makes working with
                    them seem effortless and a pleasure. They have always
                    provided excellent support and are responsive to our
                    requests, delivering eloquent results in a timely manner"
                  </div>
                  <span>⭐⭐⭐⭐⭐</span>
                  <div className="men">
                    <div>
                    ...
                    <div>
                      <span className="busines">
                        Business System Analyst,Change{" "}
                      </span>
                      <br />
                      <span className="busines">Healthcare</span>
                      <br />
              ...
              <div className="col-lg-4 images-small-top">
                <div className="card">
                  <div className="card-text">
                    "Key Software,Inc. have been helping our organization
                    utilize our claims and utilization platform more effectively
                    and efficiently. They took the time to clearly understand
                    our business needs and understand the workflows. They
                    engaged with our technical team and the business process
                    owners to ensure they understood the issues well. Karthik is
                    very solution oriented and innovative in finding solutions."
                  </div>
                  <span>⭐⭐⭐⭐⭐</span>
                  <div className="men">
                    <div>
                    ...
                    <div>
                      <span className="busines">
                        CEO & Founder, Imperial Health Plan{" "}
                      </span>
                      <br />
                      <span className="busines"> of California, Inc.</span>
                      <br />
